<nav x-data="{ open: false }" class="bg-archer-charcoal border-b border-archer-neon">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="bg-archer-charcoal border border-gray-700">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')"
                    class="text-gray-300 hover:bg-archer-dark hover:text-archer-neon hover:border-archer-neon border-transparent">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
