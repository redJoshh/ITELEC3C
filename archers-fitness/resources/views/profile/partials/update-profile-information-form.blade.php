    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="height" :value="__('Height (cm)')"
                class="text-archer-neon font-bold uppercase tracking-wide" />
            <x-text-input id="height" name="height" type="number" step="0.1"
                ...
                :value="old('height', $user->height)" placeholder="e.g. 175" />
        ...
        <div>
            ...
            <x-text-input id="weight" name="weight" type="number" step="0.1"
                class="mt-1 block w-full bg-archer-dark border-gray-600 text-white focus:border-archer-neon focus:ring-archer-neon"
                :value="old('weight', $user->weight)" placeholder="e.g. 70.5" />
