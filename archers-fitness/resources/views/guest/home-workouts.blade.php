<x-guest-layout>
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="text-center mb-12" data-aos="fade-down">
            <h1 class="text-4xl font-graduate md:text-5xl font-extrabold text-white uppercase tracking-tight">Free <span
                    class="text-archer-neon">Workouts</span></h1>
            <div class="h-1 w-24 bg-archer-neon mx-auto mt-4 rounded"></div>
            <p class="mt-6 text-gray-300 text-lg max-w-2xl mx-auto font-playfair">
        ...
        <div class="bg-archer-charcoal border border-gray-700 rounded-xl p-8 text-center max-w-3xl mx-auto mb-20 shadow-2xl transition-all duration-300 hover:border-archer-neon"
            ...
            @if (strtolower($focusArea) === 'default')
                <h2 class="text-3xl font-bold text-white mb-4 uppercase font-graduate">
                    <span class="text-archer-neon">Select a Target</span>
                </h2>
            @else
                <h2 class="text-3xl font-bold text-white mb-4 uppercase font-graduate">Target: <span
                        class="text-archer-neon">{{ $focusArea }}</span>
                </h2>
            @endif


            <ul class="text-xl text-gray-300 leading-relaxed mb-8 font-playfair">
            ...
            <div
                ...
                <p class="text-gray-400 text-sm leading-relaxed">
                    <strong class="text-white uppercase tracking-wide font-playfair">Trainer's Note:</strong> Remember,
                    strength
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-archer-dark p-8 md:p-12 rounded-2xl border border-gray-800 shadow-2xl"
            ...
            <div>
                <h2
                    class="text-3xl font-bold font-graduate text-white uppercase mb-4 border-l-4 border-archer-neon pl-4">
                    The Beginner
                    Blueprint</h2>
