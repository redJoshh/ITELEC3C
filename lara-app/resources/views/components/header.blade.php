...
<body class="bg-gray-100">
    ...
    <header class="bg-blue-900 text-white p-4">
        ...
        <nav id="mobile-menu" class="hidden md:hidden bg-blue-900 text-white mt-5 pb-4 space-y-2">
            ...
            <a href="{{ url('/login') }}"
                class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('login') ? 'text-yellow-500 font-bold' : '' }}">Login</a>
            <a href="{{ url('/register') }}"
                class="block px-4 py-2 hover:bg-blue-700 {{ request()->is('register') ? 'text-yellow-500 font-bold' : '' }}">Register</a>
    ...
    <main class="container mx-auto p-4 mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="rounded-lg shadow-md bg-white p-4">
                <div class="flex items-center space-between gap-4">
                    <img src="/images/logos/logo-bitwave.png" alt="" class="w-14" />
                    <div>
                        <h2 class="text-xl font-semibold">
            ...
            <div class="rounded-lg shadow-md bg-white p-4">
                <div class="flex items-center space-between gap-4">
                    <img src="/images/logos/logo-nextgen.png" alt="" class="w-14" />
                    <div>
            ...
            <div class="rounded-lg shadow-md bg-white p-4">
                <div class="flex items-center space-between gap-4">
                    <img src="/images/logos/logo-quantumcode.png" alt="" class="w-14" />
                    <div>
            ...
            <div class="rounded-lg shadow-md bg-white p-4">
                <div class="flex items-center space-between gap-4">
                    <img src="/images/logos/logo-shield.png" alt="" class="w-14" />
                    <div>
                        <h2 class="text-xl font-semibold">
                            Graphic Designer
                        </h2>
            ...
            <div class="rounded-lg shadow-md bg-white p-4">
                <div class="flex items-center space-between gap-4">
                    <img src="/images/logos/logo-sparkle.png" alt="" class="w-14" />
                    <div>
                        <h2 class="text-xl font-semibold">
                            Data Scientist
                        </h2>
